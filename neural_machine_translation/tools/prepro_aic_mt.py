...
parser.add_argument('-train_src', default='/home/jxgu/github/unparied_im2text_jxgu/data/ai_challenger/machine_translation/nmt_t2t_data_filtered_0129/train_0129.zh',
                    help="Path to the training source data")
parser.add_argument('-train_tgt', default='/home/jxgu/github/unparied_im2text_jxgu/data/ai_challenger/machine_translation/nmt_t2t_data_filtered_0129/train_0129.en',
                    help="Path to the training target data")
parser.add_argument('-valid_src', default='/home/jxgu/github/unparied_im2text_jxgu/data/ai_challenger/machine_translation/nmt_t2t_data_filtered_0129/valid_0129.zh',
                    help="Path to the validation source data")
parser.add_argument('-valid_tgt', default='/home/jxgu/github/unparied_im2text_jxgu/data/ai_challenger/machine_translation/nmt_t2t_data_filtered_0129/valid_0129.en',
                    help="Path to the validation target data")

parser.add_argument('-save_data', default='/home/jxgu/github/unparied_im2text_jxgu/data/ai_challenger/machine_translation/nmt_t2t_data_filtered_0129/nmt_filtered_0129',
